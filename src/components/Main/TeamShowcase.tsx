...
const teamMembers = [
  {
    ...
    bio: "10+ years in tech leadership, passionate about innovation and team building."
  },
  {
    name: "Maria Garcia",
    ...
    bio: "Design visionary with expertise in UX/UI and brand identity."
  },
  {
    name: "David Chen",
    role: "Lead Developer",
  ...
  },
  {
    ...
    bio: "Agile expert ensuring projects are delivered on time and on budget."
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {teamMembers.map((member, index) => (
            <motion.div
              key={index}
              className="bg-white dark:bg-gray-700 rounded-xl overflow-hidden shadow-light dark:shadow-none border border-gray-100 dark:border-gray-600"

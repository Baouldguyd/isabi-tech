...
const Services = () => {
  ...
  return (
    <div className=" h-[80rem] bg-[#EBEDEE] rounded-md ">
      {/* Our services */}
        ...
        <div className=" flex flex-col gap-4">
          ...
          <span className=" flex flex-col  gap-4">
            ...
            {userExp.map((item, index) => (
              <div key={index} className=" w-[265px] h-[160px] p-4 flex gap-4 flex-col bg-white rounded-md">
                {/* Icon div */}
                <div className=" w-[40px] h-[40px] bg-[#EBEDEE] p-2 rounded-md  flex items-center justify-center">
                  {item.icon}
                </div>
                {/* Text div */}
                <div>
